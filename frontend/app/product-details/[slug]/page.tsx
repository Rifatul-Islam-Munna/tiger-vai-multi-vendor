        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            {product.colors.length > 0 && (
              <div className="space-y-3">
                <h4 className="font-medium text-palette-text">Color</h4>
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg border transition-colors ${
                        selectedColor === color
                          ...
                          : "border-gray-200 hover:border-gray-300 text-palette-text"
                      }`}
                    >
                      {color}
                    </button>
            ...
            {product.size && (
              <div className="space-y-3">
                <h4 className="font-medium text-palette-text">Size</h4>
                <div className="flex gap-2">
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-3">
                <button className="flex-1 border-2 border-gray-200 py-3 px-6 rounded-lg font-medium text-palette-text hover:border-palette-btn hover:bg-palette-btn/5 transition-colors">
                  Add to Wishlist
                </button>
            ...
            <div className="space-y-3 border-t border-gray-200 pt-6">
              ...
              <div className="flex items-center gap-3 text-gray-600">
                ...
                <div>
                  <p className="font-medium text-palette-text">Easy Returns</p>
                      ...
                      {[5, 4, 3, 2, 1].map((rating) => (
                        ...
                        >
                          ...
                          <div className="flex-1 bg-gray-200 rounded-full h-2">
                            <div
                              className="bg-palette-btn h-2 rounded-full"
                              style={{
                                width: `${
                                  rating === 5
                                    ? 60
