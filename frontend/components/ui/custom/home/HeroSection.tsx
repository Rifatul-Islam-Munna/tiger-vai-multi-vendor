    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-20 items-center">
        ...
        <div className="md:col-span-6 lg:col-span-7 flex justify-center">
          <div className="aspect-[4/3] md:h-[480px] md:min-h-[380px] w-full rounded-3xl border border-palette-accent-2 bg-white flex items-center justify-center relative overflow-hidden shadow-sm">
            <div className="flex flex-col items-center text-palette-accent-2">
              <Store className="w-24 h-24 opacity-30 mb-4" />
              <span className="text-xl font-medium tracking-wide opacity-40">
                Your Marketplace
              </span>
            </div>
            {/* Featured Vendor Floating Card */}
            <div className="absolute bottom-8 left-8 bg-white/90 backdrop-blur-sm p-4 rounded-xl border border-palette-accent-2 max-w-[220px] hidden sm:block">
              ...
              <p className="text-sm font-semibold mt-1 text-palette-btn">
                Up to 40% Off
              </p>
            </div>
          </div>
