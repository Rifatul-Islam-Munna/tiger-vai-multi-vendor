    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      >
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="flex items-center gap-3">
                {product.offerPrice ? (
                  <>
                    <span className="text-2xl font-bold" style={{ color: "var(--palette-btn)" }}>
                      ৳{product.offerPrice}
                    </span>
                    <span className="text-lg line-through" style={{ color: "var(--palette-accent-3)" }}>
                      ৳{product.price}
                    </span>
                  </>
                ) : (
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <Tag size={16} />
                <span>{product.category.main} → {product.category.category}</span>
              </div>
            </div>
        ...
        {product.variants && product.variants.length > 0 && (
          <div className="mt-6">
            <h3 className="text-sm font-semibold mb-3 flex items-center gap-2" style={{ color: "var(--palette-accent-1)" }}>
              <Layers size={16} />
              VARIANTS
            </h3>
                ...
                >
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-sm mt-1" style={{ color: "var(--palette-accent-3)" }}>
                        Stock: {variant.stock}
                      </p>
                    </div>
                    <div className="text-right">
                      {variant.discountPrice ? (
                        <>
                          <p className="font-semibold" style={{ color: "var(--palette-btn)" }}>
                            ৳{variant.discountPrice}
                          </p>
                          <p className="text-sm line-through" style={{ color: "var(--palette-accent-3)" }}>
                            ৳{variant.price}
                          </p>
                        </>
                      ) : (
